...
/*	public void notify_upload(String contentId) throws RemoteException
	...
	public String upload(String data,int size,String requester) throws RemoteException
	{
		...
		session.upload(contentName, size,requester);
		ContentState downloadStateObject = new ContentState(data,0,bitMap,-1,null,size,0,ContentState.Type.tcpDownload,"1",true);
		...
		ContentState uploadStateObject = new ContentState(data,contentName,0,bitMap,Connection.Type.DSL.ordinal(),
	...
	public int processDynamicContent(String objectId,int uploadSize,String contentId,Connection.Type type,String requester,String conId) throws RemoteException
	{
		...
		{	
			...
			ContentState stateObject = new ContentState("1$1.jpg",contentId,0,bitMap,type.ordinal(),destination,segments,0,ContentState.Type.tcpUpload,cacheId,true);
		...
		else
		{
			...
			BitSet bitMap = null;
			ContentState stateObject = new ContentState("1$1.jpg",contentId,0,bitMap,Connection.Type.USB.ordinal(),
